...
package axi_bus_pkg;
    ...
    localparam int WSTRB          = DATA_BEAT_WIDTH/8;
    ...
    // Arbiter widths
    localparam int ARGRANT        = 1 + ARID;
    localparam int AWGRANT        = 1 + AWID;
